...
hasil sampling digunakan untuk mining
'''
...
filename = 'synthetic1'
desiredSamples = 5000
with open('dataset/' + filename + '.txt') as openfileobject:
...
fOut = open('dataset/sampling_' + filename + '.txt', 'w')
samplingTime = 0
writingTime = 0
countFrequent = 0
        ...
        if index==p:
            ...
            while True:
                ...
                if flag:
                    ...
                    break
        index += 1
    fOut.write(setToSpmf(uGenerated) + '\n')
